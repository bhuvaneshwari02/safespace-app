...
<br><input type="text" class="form-control" required="required" name="title" id="title" class="resizedTextbox"  value="<?php echo $name ?>" ><br>
	
    <textarea class="form-control" id="content" name="content" rows="3" ><?php echo $cons ?></textarea>
  </div>

 
		<center><button type="submit" class="btn" name="save" value="save">Update</button>
</center>
